...
- **Audric Intelligence** — the brain. Five systems: Agent Harness (34 tools), Reasoning Engine (9 guards, 7 skill recipes), Silent Profile, Chain Memory, AdviceLog. The moat. Picks the right tool, clears the guards, never surfaces as a notification — only ever shapes the next reply or executes the next action.
