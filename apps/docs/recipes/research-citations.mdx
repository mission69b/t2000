...
One question in, a sourced answer out. Exa surfaces the most relevant primary pages, Perplexity returns a web-grounded answer with live citations, and Claude (optionally) fuses them into a cited brief. ~$0.06.
