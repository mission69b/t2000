...
The same prompt goes to five models in parallel — Claude, GPT, Gemini, Groq (Llama), DeepSeek — then Claude judges the answers blind on accuracy, completeness, and tone. ~$0.14, one wallet, no provider accounts.
