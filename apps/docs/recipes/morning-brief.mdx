...
description: "Chain CoinGecko + NewsAPI + Anthropic over MPP. Three paid calls, ~$0.03, zero API keys."
---
...
Each call returns HTTP 402, your wallet signs a tiny USDC payment, the gateway proxies upstream and returns 200. Total ~$0.03, ~6s end to end.
