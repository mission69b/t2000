...
description: "One sentence in, a printable picture book out. Claude writes the story, Flux illustrates every page in a consistent style, and PDFShift binds it server-side. ~$0.34."
---

One premise in, a short illustrated children's book out: Claude writes the story beat-by-beat, fal.ai's Flux paints a consistent illustration for each page, and PDFShift binds them into a print-ready PDF. ~$0.34, no API keys.
