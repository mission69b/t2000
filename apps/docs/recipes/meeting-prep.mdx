...
Perplexity pulls a web-grounded company brief, Exa profiles the person, Serper grabs the latest news, and Claude distills it into a pre-meeting brief. ~$0.08 — inputs are a name, a company, and the topic.
