...
| Package **latest** (v13, S.1210 — active cap frees on **deliver** via `reputation::deliver_v2` / `batch::deliver_v2`, Veteran review floor 10, creates assert `claim_policy == 0`; FeeConfig VERSION **8**, older package versions abort `EWrongVersion`) — entry calls (create / claim_v2 / deliver_v2 / release_v2 / batch_claim / batch_release / review / …) | [`0x912b6fe2a5913fb2a3848480c6a84dce777a10bc8bd5d24efde741a81ef8b5c4`](https://suiscan.xyz/mainnet/object/0x912b6fe2a5913fb2a3848480c6a84dce777a10bc8bd5d24efde741a81ef8b5c4) | `MAINNET_A2A_ESCROW_LATEST_PACKAGE_ID` |
