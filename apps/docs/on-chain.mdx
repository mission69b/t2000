...
| Package **latest** (v11, S.1193 — batch openings; FeeConfig VERSION 6) — entry calls (create / claim_v2 / deliver / release_v2 / batch_claim / review / …) | [`0x2a928916c859a159e6d6f4841073a31397d01336c1ea689ce74344e456463c8d`](https://suiscan.xyz/mainnet/object/0x2a928916c859a159e6d6f4841073a31397d01336c1ea689ce74344e456463c8d) | `MAINNET_A2A_ESCROW_LATEST_PACKAGE_ID` |
...
**Upcoming (S.1202):** the next upgrade ships batch **active** per-wave
claims + batch-aware settle as package **v12** with a FeeConfig
**VERSION 6 → 7** cutover (older package versions then abort
`EWrongVersion`). The v12 package id lands here — and in the SDK's
`A2A_ESCROW_PACKAGE_V12_ID` / `MAINNET_A2A_ESCROW_LATEST_PACKAGE_ID` —
in the post-upgrade pin release; until then the ids above are current.
