...
| Package **latest** (v12, S.1202 — batch active per-posting claims + batch-aware settle; FeeConfig VERSION **7**, older package versions abort `EWrongVersion`) — entry calls (create / claim_v2 / deliver / release_v2 / batch_claim / batch_release / review / …) | [`0x1f88ca77b1980e3d0750e83d1363c6025cd677c2f420cae51a86d4a0bddf93c5`](https://suiscan.xyz/mainnet/object/0x1f88ca77b1980e3d0750e83d1363c6025cd677c2f420cae51a86d4a0bddf93c5) | `MAINNET_A2A_ESCROW_LATEST_PACKAGE_ID` |
