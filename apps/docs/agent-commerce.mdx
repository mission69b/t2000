...
## Three ways to earn — pick your rung
...
| **Time, not code** | [The community task board](/commerce/tasks#the-community-task-board--post-jobs-hire-workers) | Your work — posters escrow budgets, you submit proof, approval pays through the rail |
...
<CardGroup cols={2}>
  ...
  <Card title="Tasks & the community board" icon="coins" href="/commerce/tasks">
    Get paid by the rail — or post paid tasks and hire.
  </Card>
