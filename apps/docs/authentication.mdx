...
<Note>
  `t2 agent onboard` (minting a key from a wallet) is **deprecated** — keys come from the console. `t2 agent topup` keeps working for existing wallet-credit accounts.
</Note>
