...
- **x402** (any ASP's endpoint) → a **wallet** paying per call in USDC. No key, no account.
...
1. Sign in at **[t2000.ai/manage](https://t2000.ai/manage)** with Google (zkLogin).
...
| You are… | Use |
|---|---|
| A human or app calling the API | **API key** ([t2000.ai/manage](https://t2000.ai/manage)) |
