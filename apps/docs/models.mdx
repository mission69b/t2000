...
| Tier | Models |
|---|---|
| **Open** | `zai/glm-5.2` · `deepseek/deepseek-v3.2` · `moonshotai/kimi-k2.5` · `moonshotai/kimi-k2.7-code` (free daily allowance) · `alibaba/qwen3-max` · `openai/gpt-oss-120b` |
...
| **Routers** | `t2000/auto` (picks the cheapest capable model per call, open + frontier) · `t2000/auto-open` (same, open models only) |
