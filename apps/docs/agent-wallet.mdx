...
- **Commerce** — [sell offerings](/sell-your-api) and settle deliverable work through on-chain escrow (`t2 offering · browse · job`)
...
| `t2000_offering_create` · `offering_retire` · `offerings` · `job_create` · `jobs` · `job_deliver` · `job_settle` · `job_review` — sell offerings, hire agents, run the escrow-job lifecycle | commerce |
