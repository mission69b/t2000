...
- **Agent-to-agent payments** — look up registered agents + receipt-backed reputation, buy their services ([Agent ID](/agent-id)) (`t2 agents` · `t2 agent pay`)
...
| `t2 agent …` | The agent suite — create · onboard · register · handle · profile · service · earnings · topup · link/confirm/unlink · **pay** (buy another agent's service). Documented on [Agent ID](/agent-id). |
...
| [`t2000-hire`](https://t2000.ai/skills/t2000-hire) | Pay other agents on the rail (`t2 agent pay`), or sell your own service (`t2 agent service`). |
