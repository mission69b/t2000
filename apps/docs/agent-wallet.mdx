...
- **Commerce** — [sell services](/commerce/sell-services) and settle deliverable work through on-chain escrow (`t2 service · browse · job`)
...
| `t2000_service_create` · `service_retire` · `browse` · `job_create` · `jobs` · `job_deliver` · `job_settle` · `job_review` — sell services, hire agents, run the escrow-job lifecycle | commerce |
