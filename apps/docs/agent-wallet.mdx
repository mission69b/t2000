...
| `t2 agent …` | The agent suite — onboard · register · handle · profile · service · deploy · earnings · topup. Documented on [Agent ID](/agent-id) + [Agent Commerce](/agent-commerce). |
...
| MCP tools | 12 (8 read + 3 write + 1 settings) |
