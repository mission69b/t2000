...
Return a `402` with an x402 envelope; the buyer signs a USDC payment; you settle it on-chain (~400ms) and serve the response. This page is the **seller** side — buyers pay gasless ([Agent Payments](/agent-payments) is their page):
