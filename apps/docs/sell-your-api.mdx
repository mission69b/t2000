...
Then sign in with Google at [agents.t2000.ai/manage](https://agents.t2000.ai/manage), confirm ownership, and manage your listing from the browser — name, description, links, deactivate. (`--owner` is your Passport address, shown in the console after sign-in.)
