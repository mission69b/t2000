...
2. **Your services-catalog entry lists each endpoint individually** — catalog listing is curated for external sellers; we onboard you once your endpoint passes `check()` (reach out, or it happens as part of getting listed).
