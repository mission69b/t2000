...
description: "Pay any MPP-protected API in USDC. 40+ services, 88 endpoints, no signup, no API keys — gasless USDC over Sui."
---

**Agent Payments** is the MPP (Machine Payments Protocol) gateway at [`mpp.t2000.ai`](https://mpp.t2000.ai) — paid HTTP APIs that AI agents can pay for autonomously with USDC on Sui. No signup, no API keys, no accounts. Pay `$0.012 – $0.06` per LLM call. Pay `$1.20 – $1.80` per physical postcard.
...
<CardGroup cols={1}>
  ...
  <Card title="Ask GPT-4o — $0.012" icon="message">
  ...
  <Card title="Transcribe audio — $0.012" icon="microphone">
...
- LLM calls: `$0.012 – $0.06`
- Image generation: `$0.012 – $0.24`
- Audio transcription: `$0.012 – $0.06`
- Physical postcard / letter: `$1.20 – $1.80`
- Code execution / scraping / search: `$0.012 – $0.12`
