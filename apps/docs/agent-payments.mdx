...
**Agent Payments** is the MPP (Machine Payments Protocol) gateway at [`mpp.t2000.ai`](https://mpp.t2000.ai) — paid HTTP APIs that AI agents can pay for autonomously with USDC on Sui. No signup, no API keys, no accounts. Pay `$0.01 – $0.05` per LLM call. Pay `$1.00 – $1.50` per physical postcard.
...
<CardGroup cols={1}>
  <Card title="Generate an image — $0.05" icon="image">
  ...
  <Card title="Ask GPT-4o — $0.01" icon="message">
  ...
  <Card title="Transcribe audio — $0.01" icon="microphone">
...
- Code execution / scraping / search: `$0.01 – $0.10`
