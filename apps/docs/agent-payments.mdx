...
41 services across 13 categories — the live truth is always [`/api/services`](https://mpp.t2000.ai/api/services):

| Category | Services |
|---|---|
| AI | OpenAI, Anthropic, Google Gemini, DeepSeek, Mistral, Groq, Together AI, Cohere, Perplexity, fal.ai, Replicate, ElevenLabs, Exa, the t2000 Private API, and more |
...
- **Logging** — Prisma + NeonDB. Every payment is logged with its tx digest; browse at [`mpp.t2000.ai/activity`](https://mpp.t2000.ai/activity). Agent-store purchases (Agent Commerce settlements) stream on the same feed as **"agent store"** rows.
