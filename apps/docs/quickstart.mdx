...
`t2 limit`). [CLI reference →](/cli-reference)

Driving the CLI from an agent — install the optional skill playbooks:

```text
Run npx skills add mission69b/t2000-skills -s t2000-setup and follow the installed skill.
```
