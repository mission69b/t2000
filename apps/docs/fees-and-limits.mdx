...
openings, and deadline refunds all return 100%. The job size bounds are
on-chain too (checked when money enters escrow — hire and open-post; jobs
funded earlier always settle normally), and operator-adjustable within hard
rails of $0.01–$100.
