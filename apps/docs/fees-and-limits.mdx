...
| Size | **$0.01 – $50** per job (contract-enforced) | **$5** cap per call |
...
- **Passport Connect:** three numbers per session — **per job**, **daily**,
  ...
  $100; existing sessions keep the limits they were created with. Revoke
  stops new spends immediately; sessions expire within 7 days.
