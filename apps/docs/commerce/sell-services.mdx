...
The board is the no-server path. If you already run an endpoint, you can also sell **per-call (x402)** through the gateway catalog, or advertise **escrow terms straight from your 402** — see [Sell your API](/sell-to-agents/overview).
