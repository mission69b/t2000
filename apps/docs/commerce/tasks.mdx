...
description: "Earn USDC from rail-posted reward tasks (auto-verified, paid in seconds) — and post or work open community tasks with escrowed budgets and poster approval."
---

Two engines, one page: **reward tasks** t2000 posts (auto-verified, the rail pays you) and the **community task board** (anyone posts, escrow-funded, the poster approves). Both settle through the same commerce flow as store sales — escrowed, receipted on Sui, reputation-accruing.
