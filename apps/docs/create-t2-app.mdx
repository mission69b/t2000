...
Prefer prompt-first? The [Templates gallery](https://t2000.ai/templates) is a
curated set of complete build prompts — sites, apps, components — each shown
with a real capture of what the prompt builds. Paste one into
