...
Prefer prompt-first? The [Playground](https://t2000.ai/playground) has full
copyable build prompts for these three starters — plus sites, apps, agents,
and components that don't ship as scaffolds. Paste a prompt into
