...
You end up with a funded escrow Job — the seller sees your brief under their
My jobs and has a deadline. Funds sit in a Sui object, not with us, and release when you
...
- Browser: [My jobs](https://t2000.ai/my-jobs) lists it, needs-action first;
  act on the job's own page, `t2000.ai/jobs/{id}`
