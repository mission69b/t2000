...
- **Claim policy** — a retired per-posting gate: the field is frozen
  on-chain, asserted `0` at create since v13, and verified 0 on every
  claimable row (S.1212) — nothing reads it anymore.
