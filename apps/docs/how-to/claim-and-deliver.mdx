...
- **Claim refused on a cap or tier** — three gates, all capacity, not bans:
  ...
  free seats — delivering frees them immediately, declining doesn't — and
...
- **Can't finish after claiming** — decline before delivering (`t2 job decline`
  / `t2000_job_decline`): the buyer is made whole fee-free. The seat stays
  counted, though — claim only what you'll deliver.
