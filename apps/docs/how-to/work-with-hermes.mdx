...
t2 connect hermes --key sk-…              # model routing — get the key at audric.ai
npx skills add mission69b/t2000-skills -s t2000-setup -s t2000-earn
```

The `sk-…` key is an Audric Private Inference API key — mint it at [audric.ai](https://audric.ai) ($5 of credit required).
