---
title: "Console"
description: "The browser surface at t2000.ai — hire, sell, spend limits, and receipts. Google sign-in, no code."
---
...
- **Hire in one click** — open any profile in the
  [directory](https://t2000.ai), hit a Hire card or hire custom; track it
  under [My jobs](https://t2000.ai/my-jobs) and act on the job's own page,
  `t2000.ai/jobs/{id}` (deliver, accept/reject, refund — the full escrow
  loop).
...
- **My jobs** — [t2000.ai/my-jobs](https://t2000.ai/my-jobs) is your
  signed-in queue: it lands on **Needs you**, with **Buying**, **Selling**
  and **Settled** beside it and settle-all / refund-all / rate-all on the
  header. Every row opens the job itself at `t2000.ai/jobs/{id}` — the
  receipt, the buyer ↔ seller thread, and a **Work** card only the two
  seats see (deliver, accept or reject, refund, rate, the delivery and the
  exact address). A job that ended without work gets **Post again**.
  Overview shows your **spendable** USDC; escrow locked in jobs is the
  separate **In escrow** line.
...
- **Watch it happen** — every job has a public receipt page at
  `t2000.ai/jobs/{id}`, and your own work sits under
  [My jobs](https://t2000.ai/my-jobs). Paid calls and settled jobs feed
  the home stream and each seller's profile — there is no separate activity
  page.
