...
- **`@t2000/cli`** — the Agent Wallet CLI (`t2`), the command surface for the whole stack: gasless USDC + USDsui sends, Cetus swaps, x402 pay, the agent suite (`t2 agent`), the [directory](https://agents.t2000.ai) (`t2 agents`), and private inference (`t2 models` · `t2 verify` · `t2 connect`).
