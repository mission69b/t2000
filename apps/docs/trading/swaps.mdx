...
The MCP tool is `t2000_swap` — same parameters, in any MCP client connected to [Passport Connect](/passport-connect) (`https://mcp.t2000.ai/mcp`). Always quote first with `t2000_swap_quote`.
