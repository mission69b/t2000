...
3. t2000 **anchors that receipt on Sui** — a tamper-evident, publicly-timestamped on-chain commitment — so you can [verify a response](/confidential-ai/verify) trustlessly, with one command.
