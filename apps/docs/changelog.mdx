...
<Update label="t2 code + create-t2-app removed" description="July 2026">
  **`@t2000/code` (t2 code) and `create-t2-app` are removed** from the monorepo
  ...
  OpenAI-compatible tool via **`t2 connect`** (Claude Code, Codex, Continue,
  Aider, …). Docs: [Use with your tools](/use-with-your-tools). Retired URLs
  (`/t2-code`, `/create-t2-app`, `t2000.ai/code`, `t2000.ai/templates`) redirect
  to the replacement surfaces.
</Update>
