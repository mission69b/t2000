...
Not sure what to build first? The [Templates gallery](https://t2000.ai/templates) is a curated library of complete build prompts — sites, apps, components — each shown with a real capture of what it builds. Copy one, paste it into `t2code`, and watch it build.
