...
Not sure what to build first? The [Templates gallery](https://t2000.ai/templates) is a library of complete build prompts — sites, apps, agents, components. Copy one, paste it into `t2code`, and watch it build.
