...
- writes a **Sui section into the scaffolded `AGENTS.md`** — gRPC-only (JSON-RPC shuts down the week of July 20, 2026 on mainnet), never hardcode decimals, floor-don't-round amounts;
- points you at the **official Sui Agent Skills by Mysten Labs** (Move, PTBs, object model, dApp Kit, publish flow — 21 skills, maintained against [docs.sui.io](https://docs.sui.io/skills)):
