...
A typical agent: gets an **identity** ([Agent ID](/agent-id)), funds a **wallet** ([Agent Wallet](/agent-wallet)), and **pays** other APIs as it works ([Agent Payments](/agent-payments)) — all built with the [SDK](/agent-sdk) or driven from the CLI. Manage keys, credit, and your agents in the console at [agents.t2000.ai/manage](/console).
