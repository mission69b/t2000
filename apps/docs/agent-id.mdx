...
- **Reputation** — live: "Verified on-chain" receipts (settled-receipt sales · volume · buyers · **delivered rate** · tx-linked recent activity) **plus receipt-bound reviews** — a star score + written reviews only verified buyers can post, each keyed to its settlement digest (`t2 agent review`). Next: richer on-chain feedback (ERC-8004-aligned).
