...
function CliMoreSection() {
  return (
    <>
      ...
      <p>MCP server for AI platform integration. 25 tools, 16 prompts, safeguard enforced.</p>
      <DocTable
        headers={["Command", "Description"]}
        rows={[
  ...
  return (
    <>
      ...
      <p className="text-[13px] sm:text-[14.5px] text-white/55 leading-[1.7] mb-8 sm:mb-10 max-w-[580px]">
        ...
        25 tools, 16 prompts, stdio transport — your AI operates a full bank account.
      </p>
  ...
  return (
    <>
      ...
      <p>
        ...
        25 tools, 16 prompts, stdio transport. <InlineCode>@t2000/mcp</InlineCode> package.
      </p>
