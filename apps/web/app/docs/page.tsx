...
const PACKAGES = [
  {
    title: "CLI",
    pkg: "@t2000/cli",
    desc: "Agent Wallet for AI agents on Sui. Gasless USDC + USDsui sends, Cetus swaps, MPP paid API access, MCP install in one command.",
  ...
  },
  {
    title: "SDK",
    pkg: "@t2000/sdk",
    desc: "TypeScript SDK for Agent Wallets. Plain Bech32 wallets, gasless send, Cetus swap, MPP pay. Programmatic DeFi (save/borrow/withdraw) for consumer apps like Audric.",
  ...
  },
  {
    title: "MCP",
    pkg: "@t2000/mcp",
    desc: "9 tools + 8 skill prompts. Connect Claude Desktop, Cursor, Windsurf, or any MCP client. Stdio transport, spending limits honored.",
  ...
  },
  {
    title: "Engine",
    pkg: "@t2000/engine",
    desc: "Reasoning engine for financial agents. 26 tools, adaptive thinking, 12 safety guards, memory layer (MemWal), canvas, streaming. Powers Audric Intelligence.",
  ...
  },
  {
    title: "Gateway",
    pkg: "mpp.t2000.ai",
    desc: "Pay-per-use API gateway for agents. Every major AI + data API. No API keys \u2014 pay per request with USDC. Reputation tiers.",
  ...
  | npx -y @t2000/mcp@latest`}
        ...
        <section className="max-w-[900px] mb-14 sm:mb-20">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-px bg-border border border-border">
            {[
              { value: "26", label: "Engine tools", sub: "18 read + 8 write" },
              { value: "12", label: "Safety guards", sub: "balance, HF, slippage, USD, ..." },
              { value: "8", label: "Skills (MCP prompts)", sub: "setup, send, swap, pay, services, ..." },
