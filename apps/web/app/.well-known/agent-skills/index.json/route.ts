...
export async function GET(): Promise<NextResponse> {
  try {
    ...
    const manifest: SkillsManifest = {
      ...
      name: "t2000-skills",
      description:
        "Agent Skills for the t2000 Agentic Wallet on Sui. Install once and your AI agent gains the ability to check balances, send payments, earn yield, borrow, swap, stake, and pay for MPP API services — all on Sui.",
      homepage: BASE_URL,
