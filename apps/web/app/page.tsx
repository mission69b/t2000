...
const THREE_PRODUCTS = [
  {
    tag: "Consumer",
    name: "Audric",
    desc: "The consumer app. Banking by conversation. Four products: Audric Passport (sign in with Google, non-custodial wallet), Audric Intelligence (40-tool agent harness — save, swap, borrow), Audric Pay (send USDC, links, invoices). Audric Store coming soon.",
...
const PRIMITIVES = [
  ...
  { title: "DeFi access (Audric Intelligence ops)", desc: "Save, swap, borrow, repay, withdraw \u2014 surfaced through the Agent Harness, gated by Passport tap-to-confirm. Savings at 3\u20138% APY via NAVI; 20+ DEX swap routing via Cetus." },
