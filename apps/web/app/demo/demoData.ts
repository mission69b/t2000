...
export const demos: Demo[] = [
  {
    ...
    lines: [
      ...
      { type: "output", text: "  Best yield: 3.31% APY (USDC on NAVI)", delay: 400 },
      { type: "output", text: "", delay: 80 },
      { type: "output", text: "  USDC", delay: 150 },
      { type: "output", text: "  ─────────────────────────────────────────────────────", delay: 80 },
      { type: "output", text: "  NAVI:  Save 3.31%  Borrow 5.84%", delay: 150 },
  ...
  },
  {
    ...
    lines: [
      ...
      { type: "output", text: "  Best yield: 5.57% APY (USDC on NAVI)", delay: 400 },
      { type: "output", text: "", delay: 80 },
      { type: "output", text: "  USDC", delay: 150 },
      { type: "output", text: "  ─────────────────────────────────────────────────────", delay: 80 },
      { type: "output", text: "  NAVI:  Save 5.57%  Borrow 7.99%", delay: 150 },
      { type: "output", text: "  Suilend:  Save 2.18%  Borrow 5.58%", delay: 150 },
  ...
  },
  {
    ...
    lines: [
      { type: "command", text: "❯ t2000 rates", delay: 0 },
      { type: "output", text: "  Best yield: 5.47% APY (suiUSDT on NAVI)", delay: 400 },
      { type: "output", text: "", delay: 80 },
      { type: "output", text: "  USDC", delay: 150 },
      { type: "output", text: "  ─────────────────────────────────────────────────────", delay: 80 },
      { type: "output", text: "  NAVI:  Save 4.94%  Borrow 5.84%", delay: 150 },
      { type: "output", text: "  Suilend:  Save 3.90%  Borrow 4.20%", delay: 120 },
      { type: "output", text: "", delay: 80 },
      { type: "output", text: "  suiUSDT", delay: 150 },
      { type: "output", text: "  ─────────────────────────────────────────────────────", delay: 80 },
      { type: "output", text: "  NAVI:  Save 5.47%  Borrow 6.12%", delay: 150 },
      { type: "output", text: "  Suilend:  Save 5.10%  Borrow 5.80%", delay: 120 },
      { type: "output", text: "", delay: 80 },
      { type: "output", text: "  suiUSDe", delay: 150 },
      { type: "output", text: "  ─────────────────────────────────────────────────────", delay: 80 },
      { type: "output", text: "  NAVI:  Save 3.10%  Borrow 4.50%", delay: 150 },
      { type: "output", text: "  Suilend:  Save 2.95%  Borrow 4.10%", delay: 120 },
      { type: "output", text: "", delay: 80 },
      { type: "output", text: "  USDsui", delay: 150 },
      { type: "output", text: "  ─────────────────────────────────────────────────────", delay: 80 },
      { type: "output", text: "  NAVI:  Save 2.80%  Borrow 3.90%", delay: 150 },
      { type: "output", text: "  Suilend:  Save 2.60%  Borrow 3.70%", delay: 120 },
      ...
      { type: "output", text: "  Amount:  $499.50", delay: 150 },
      { type: "output", text: "", delay: 80 },
      { type: "output", text: "  Economics", delay: 200 },
      { type: "output", text: "  ─────────────────────────────────────────────────────", delay: 80 },
      { type: "output", text: "  APY Gain:  +0.53%", delay: 150 },
      { type: "output", text: "  Annual Gain:  $2.65/year", delay: 150 },
      { type: "output", text: "  Swap Cost:  ~$0.01", delay: 150 },
      { type: "output", text: "  Break-even:  2 days", delay: 150 },
      { type: "output", text: "", delay: 80 },
      { type: "output", text: "  Steps", delay: 200 },
      { type: "output", text: "  ─────────────────────────────────────────────────────", delay: 80 },
      { type: "output", text: "    1. Withdraw $499.50 USDC from navi", delay: 150 },
      { type: "output", text: "    2. Swap USDC → suiUSDT (~$499.50)", delay: 150 },
      { type: "output", text: "    3. Deposit $499.50 suiUSDT into navi", delay: 150 },
      { type: "output", text: "", delay: 300 },
      ...
      { type: "output", text: "  ─────────────────────────────────────────────────────", delay: 80 },
      { type: "output", text: "  navi:  $499.50 suiUSDT @ 5.47% APY", delay: 200 },
    ],
  },
  {
    id: "suilend",
    ...
    lines: [
      { type: "command", text: "❯ t2000 rates", delay: 0 },
      { type: "output", text: "  Best yield: 6.12% APY (USDC on Suilend)", delay: 400 },
      { type: "output", text: "", delay: 80 },
      { type: "output", text: "  USDC", delay: 150 },
      { type: "output", text: "  ─────────────────────────────────────────────────────", delay: 80 },
      { type: "output", text: "  NAVI:  Save 3.84%  Borrow 5.99%", delay: 150 },
      { type: "output", text: "  Suilend:  Save 6.12%  Borrow 8.45%", delay: 150 },
      ...
      { type: "output", text: "  Savings", delay: 400 },
      { type: "output", text: "  ─────────────────────────────────────────────────────", delay: 80 },
      { type: "output", text: "  suilend:  $50.00 USDC @ 6.12% APY", delay: 200 },
