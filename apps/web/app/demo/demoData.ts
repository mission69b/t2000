...
export const demos: Demo[] = [
  ...
  // ── 2. Strategies & DCA ────────────────────────────────────────────────
  {
    ...
    description:
      "Buy into a themed multi-asset strategy with one command — bluechip, layer1, or sui-heavy. Set up dollar-cost averaging for automated recurring purchases. One atomic transaction, multiple assets.",
    tweet: "t2000 invest strategy buy bluechip 100 — BTC + ETH + SUI in one atomic tx. Then DCA it weekly.",
    lines: [
      { type: "command", text: "❯ t2000 invest strategy list", delay: 0 },
      { type: "output", text: "", delay: 200 },
      { type: "output", text: "  Investment Strategies", delay: 200 },
      { type: "info", text: "  ──────────────────────────────────────", delay: 80 },
      { type: "output", text: "  bluechip:   BTC 40%, ETH 40%, SUI 20%", delay: 150 },
      { type: "output", text: "              Large-cap crypto index", delay: 100 },
      { type: "output", text: "  layer1:     ETH 50%, SUI 50%", delay: 150 },
      { type: "output", text: "              Smart contract platforms", delay: 100 },
      { type: "output", text: "  sui-heavy:  SUI 70%, BTC 15%, ETH 15%", delay: 150 },
      { type: "output", text: "              Sui-weighted portfolio", delay: 100 },

      { type: "command", text: "❯ t2000 invest strategy buy bluechip 10", delay: 1200 },
      { type: "success", text: "  ✓ Invested $10.00 in bluechip strategy", delay: 800 },
      { type: "info", text: "  BTC:  0.00005600 @ $71,326", delay: 200 },
      { type: "info", text: "  ETH:  0.001890 @ $2,119", delay: 200 },
      { type: "info", text: "  SUI:  1.9417 @ $1.03", delay: 200 },
      { type: "info", text: "  Total invested:  $10.00", delay: 200 },
