...
const TABS: TerminalTab[] = [
  {
    ...
    lines: [
      ...
      { text: "  │  Agentic Wallet for AI agents           │", color: "dim", delay: 80 },
      ...
      { text: "", delay: 200 },
      { text: "  🎉 Agentic Wallet created", color: "green", delay: 300 },
  ...
  },
  {
    ...
    lines: [
      ...
      { text: "  Gas   0.0012 SUI", color: "dim", delay: 200 },
  ...
  },
  {
    ...
    lines: [
      ...
      { text: "", delay: 300 },
      { text: "  import { WRITE_TOOL_SET } from '@t2000/engine'", color: "dim", delay: 200 },
      { text: "  const agent = new Experimental_Agent({ tools: WRITE_TOOL_SET })", color: "dim", delay: 200 },
      { text: "", delay: 300 },
  ...
  },
  {
    ...
    lines: [
      ...
      { text: "", delay: 400 },
      { text: "  ✓ Payment Request", color: "green", delay: 300 },
      { text: "  ──────────────────────────────────────", color: "dim", delay: 100 },
      { text: "  Address   0x8b3e...d412", color: "yellow", delay: 150 },
      { text: "  Network   Sui Mainnet", color: "white", delay: 100 },
      { text: "  Nonce     a1b2c3d4-...7890", color: "white", delay: 100 },
      { text: "  Amount    $50.00 USDC", color: "white", delay: 100 },
      { text: "  Label     Consulting fee", color: "white", delay: 100 },
      { text: "  ──────────────────────────────────────", color: "dim", delay: 100 },
      { text: "", delay: 200 },
      { text: "  Payment URI  sui:pay?receiver=0x8b3e...d412", color: "dim", delay: 150 },
      { text: "               &amount=50000000&nonce=a1b2...", color: "dim", delay: 80 },
      { text: "", delay: 400 },
      { text: "  Share this URI or scan the QR to pay via any Sui wallet.", color: "dim", delay: 300 },
      { text: "", delay: 800 },
      { text: "$ t2000 receive", color: "white", delay: 800 },
      { text: "", delay: 400 },
      { text: "  Address   0x8b3e...d412", color: "yellow", delay: 300 },
      { text: "  Nonce     f9e8d7c6-...4321", color: "white", delay: 150 },
      { text: "", delay: 200 },
