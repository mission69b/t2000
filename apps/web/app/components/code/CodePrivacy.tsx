...
const MODES = [
  ...
  },
  {
    ...
    points: [
      ...
      "Planning and hard retries escalate to Claude or GPT.",
      "Still zero data retention — you pay for the model that served.",
    ],
  ...
  },
  {
    ...
    green: true,
    points: [
      "Every call runs inside an attested GPU enclave (TEE).",
      "Every response carries a signed receipt anchored on Sui.",
      "t2 verify checks the proof on your machine.",
    ],
