// ============================================================
// PaymentsCloser — "Pay your first API in 30 seconds."
// Real t2 pay command in a copyable terminal card.
// ============================================================
function PaymentsCloser() {
      ...
      <div style={{ position: "relative", maxWidth: 820, margin: "0 auto", textAlign: "center" }}>
        ...
        <div style={{
          ...
          <pre style={{
            ...
            https://mpp.t2000.ai/openai/v1/chat/completions <span style={{ color: "var(--fg-subtle)" }}>\</span>{"\n"}
            {"  "}<span style={{ color: "var(--fg-subtle)" }}>--data</span>{" "}
            <span style={{ color: "var(--ds-amber-700)" }}>'{"{"}"model":"gpt-4o","messages":[{"{"}"role":"user","content":"Hello"{"}"}]{"}"}'</span>
          </pre>
        </div>

        <div style={{ marginTop: 28, fontSize: 14, color: "var(--fg-muted)" }}>
          No wallet?{" "}
          <a href="agent-wallet.html" style={{ color: "var(--fg)", textDecoration: "none", borderBottom: "1px solid var(--ds-gray-alpha-500)" }}>
            Install the Agent Wallet
          </a>{" "}
          <span style={{ opacity: 0.4 }}>·</span>{" "}
          <a href="https://developers.t2000.ai/agent-payments" style={{ color: "var(--fg)", textDecoration: "none", borderBottom: "1px solid var(--ds-gray-alpha-500)" }}>
            Read the docs ↗
          </a>
        </div>
      </div>
...
window.PaymentsCloser = PaymentsCloser;
