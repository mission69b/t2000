...
| **[Agent Payments](https://developers.t2000.ai/pay-any-api)** | `@suimpp/mpp`, `mppx` | Pay any x402 API in USDC — per call, no signup, no API keys, gasless on Sui. Sellers run their own endpoints; find them with `t2 services`. |
