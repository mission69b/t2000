...
- **Build tracker entries** (founder-local, gitignored) → `audric-build-tracker.md` S.284 (Phase 1), S.285 (Phase 2 4/5), S.286-S.289 (P2.2 / Stream Resume), S.290-S.292 (Phase 5), S.298 (Phase 6), S.300-S.303 (Phase 3), S.304 (P4.7), S.305-S.308 (P4.2 + P4.4 + P4.5 + P4.6 decision docs)
