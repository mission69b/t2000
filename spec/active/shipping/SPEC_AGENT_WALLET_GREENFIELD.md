...
> **Status:** 🟢 ACTIVE — Phase A DONE 2026-05-26 (S.328-S.335; 8/8 mainnet smokes); Phase B Step 1 DONE 2026-05-26 (S.336); Simplification cut DONE 2026-05-26 (S.337 — legacy-wallet *detection* removed); `--import` restored 2026-05-26 (S.338 — clean Bech32 import primitive, not tied to v3 migration); Phase B Steps 2-4 next
...
| B | S.336 + S.337 + S.338 | 🟡 Step 1 ✅ **DONE 2026-05-26** (S.336 — MCP + skills sweep) + Simplification cut ✅ **DONE 2026-05-26** (S.337 — legacy-wallet *detection* removed; `unlock.ts` → `agent.ts` rename) + `--import` restored ✅ **DONE 2026-05-26** (S.338 — clean Bech32 import primitive). Steps 2-4 (README rewrite + cross-client render verification + optional mpp absorption) pending. |
| C | pending | |
| D | pending | |
| E | pending | |
| F | pending | |
