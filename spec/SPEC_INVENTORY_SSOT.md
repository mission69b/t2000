...
### 1.5 `spec/reference/` + `spec/runbooks/` (17 files — +1 in S.303)

All long-lived, all current. No drift. No action. S.303 (2026-05-24) added `spec/reference/MCP_PROMPTS_INTEGRATION_DECISION.md` documenting the dormant `McpPromptAdapter` + `skillRecipeBlock` strategic seam (closes `SPEC_AI_SDK_HARDENING.md` P3.3).
