...
### 1.2 `spec/active/shipping/` (4 files — Phase 5 smoke archived 2026-05-25)
...
| `SPEC_AI_SDK_HARDENING.md` | 🟢 SHIPPING — 6/7 phases SHIPPED, only Phase 7 (bundle hardening) remains | Phase 1 SHIPPED (S.284). Phase 2 SHIPPED (S.285 + S.286-S.289 for P2.2 / Stream Resume sub-SPEC). Phase 5 CLOSED (S.290 — P5.2+P5.3+P5.4; S.291 — P5.1; S.292 — P5.6; P5.5 via Stream Resume). Phase 6 SHIPPED (S.298 typed-error classification + S.299 PII self-audit). Phase 3 CLOSED (S.300 P3.2 + S.301 P3.4 + S.302 P3.1 + S.303 P3.3 dormant seam decision doc + S.309 P3.1 smoke hotfix). Phase 4 CLOSED (S.304 P4.7 + S.305-S.308 decision docs + S.311 P4.3 DEFERRED + **P4.1 SHIPPED 2026-05-25 as engine v3.0.0** + **P4.1 follow-up SHIPPED 2026-05-25 as engine v3.1.0** — dead `LLMProvider` pathway retired, CLI/MCP ESLint configs landed, Audric `TurnMetrics.todoUpdateCount` dropped via Prisma migration). **Only Phase 7 (P7.2 `inputCoinFromStep` + P7.3 cetusRoute fast-path + P7.5 streaming bundle assembly UX) remains.** Promote to `archive/v07f/` once Phase 7 marked SHIPPED or cleanly deferred. |
