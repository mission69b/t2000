...
>
> Last updated: 2026-05-07 (post-SPEC-12 P2 — tool count refresh to 35, guards 14, recipes 6; aligned with shipped reality)
...
| 🧠 **Audric Intelligence** | Brain (the moat) — 5 systems orchestrate every money decision: Agent Harness (35 tools), Reasoning Engine (14 guards, 6 skill recipes), Silent Profile, Chain Memory, AdviceLog                                         | `@t2000/engine` (QueryEngine + tools + reasoning + guards + recipes)                                    | Live                  |
