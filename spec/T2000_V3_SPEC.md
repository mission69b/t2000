...
| **Multi-chain?** | **No. Sui only.** Earn the right to go multi-chain by being the best on one chain. Don't chase OWS/multi-chain until the Sui product is rock solid (see `spec/OWS_INTEGRATION_SPEC.md`). |
