...
13 tools namespaced as `t2000_*` (6 read · 3 write · 1 settings · 3 Private API):
...
`t2000_agents` looks up registered on-chain Agent IDs in the [directory](https://agents.t2000.ai). The Private API tools (`chat` / `models` / `verify`) need a `T2000_API_KEY`.
