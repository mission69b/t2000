...
export function registerPrompts(server: McpServer): void {
  ...
  server.prompt(
    'optimize-yield',
    'Analyze savings positions — rate comparisons, rebalancing opportunities across protocols.',
    async () => ({
      messages: [{
        role: 'user',
        content: {
      ...
      messages: [{
        ...
        content: {
          ...
          text: [
            ...
            '  - Which protocol + asset offers the best yield (compare across protocols, USDC vs USDe etc.)',
        ...
        messages: [{
          ...
          content: {
            ...
            text: [
              ...
              '  2. Rebalance existing savings for better APY (t2000_rebalance dryRun: true)',
              '  3. Claim pending rewards (if available)',
              '',
      ...
      messages: [{
        ...
        content: {
          ...
          text: [
            ...
            '  - Save/withdraw USDC (earn yield on NAVI)',
  ...
  server.prompt(
    'optimize-all',
    'One-shot full optimization — sweep idle funds, rebalance savings, claim rewards.',
    async () => ({
      messages: [{
        role: 'user',
        content: {
          ...
          text: [
            ...
            '────────────────────',
            '',
            'Check all 3 optimization levers and present a plan BEFORE executing:',
            '',
