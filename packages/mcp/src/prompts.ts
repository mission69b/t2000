      ...
      messages: [{
        ...
        content: {
          ...
          text: [
            ...
            '   % of investments in each asset (SUI, BTC, ETH)',
      ...
      messages: [{
        ...
        content: {
          ...
          text: [
            ...
            '  - bluechip (40% BTC, 40% ETH, 20% SUI) — diversified, lower risk',
            '  - layer1 (50% ETH, 50% SUI) — Ethereum + Sui ecosystem bet',
            '  - sui-heavy (70% SUI, 15% BTC, 15% ETH) — high conviction on Sui',
            '  - single asset (100% SUI/BTC/ETH) — concentrated conviction play',
