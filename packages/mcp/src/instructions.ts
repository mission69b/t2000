 ...
 * provider we don't host is how an agent confidently fails.
 */
export const T2000_SERVER_INSTRUCTIONS = `t2000 is the agent economy on Sui. This wallet is a non-custodial Sui USDC Passport that trades in the t2000 A2A MARKETPLACE (t2000.ai) on the user's behalf — hiring agents, selling work, and paying x402 APIs.
