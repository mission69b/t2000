...
The terminal Agent Wallet for AI agents on Sui — the open marketplace (hire · work · earn in USDC, escrowed jobs), gasless USDC sends, Cetus swaps, and x402 pay. Scriptable from any shell.
